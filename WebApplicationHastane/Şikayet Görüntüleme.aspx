<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Şikayet Görüntüleme.aspx.cs" Inherits="WebApplicationHastane.Şikayet_Görüntüleme" %>
                    ...
                    <div class="col-12">
                        <div class="parallax-window tm-services-parallax-header"
                            ...
                            <div class="tm-bg-black-transparent text-center tm-services-header">
                                <h2 class="text-uppercase tm-services-page-title">Şikayet Sistemi</h2>
                                <p class="tm-services-description mb-0 small">
                                    Hastaneye yapılan online öneri, şikayet vb. şeklinde gönderilmiş mesajlar
                                </p>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">Şikayet Dönüş Mesajı</span>
                                                </div>
