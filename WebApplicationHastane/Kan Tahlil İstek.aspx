<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kan Tahlil İstek.aspx.cs" Inherits="WebApplicationHastane.Kan_Tahlil_İstek" %>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="input-group mb-3">
                                                ...
                                                <asp:DropDownList ID="ddlTetkik" runat="server" DataValueField="Id" DataTextField="Ad" CssClass="form-control btn btn-primary" AutoPostBack="True"></asp:DropDownList>
