<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HastaYatış.aspx.cs" Inherits="WebApplicationHastane.HastaYatış" %>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <div class="tm-bg-black-transparent tm-services-detail-box">
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="input-group mb-3">
                                                ...
                                                <asp:DropDownList ID="ddlHasta" runat="server" CssClass="btn btn-primary form-control" DataValueField="ID" DataTextField="AdSoyad" AutoPostBack="True" ></asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="input-group mb-3">
                                    ...
                                    <div class="col-12">
                                        <asp:Button ID="btnyatisyap" runat="server" Text="Yatış Yap" class="btn btn-success form-control" OnClick="btnyatisyap_Click" />
                                    </div>
                                </div>                                
                            </ContentTemplate>
                            <Triggers>
