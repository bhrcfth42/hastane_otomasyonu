<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tedavi.aspx.cs" Inherits="WebApplicationHastane.Tedavi" %>
                            ...
                            <ContentTemplate>
                                <div class="tm-bg-black-transparent tm-services-detail-box">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="input-group mb-3">
                                                ...
                                                <asp:DropDownList ID="ddlDoktor" runat="server" CssClass="btn btn-primary form-control" DataValueField="ID" DataTextField="AdSoyad" AutoPostBack="True" OnSelectedIndexChanged="ddlDoktor_SelectedIndexChanged"></asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="input-group mb-3">
                                        ...
                                        <div class="col-6">
                                            <div class="input-group mb-3">
                                                ...
                                                <asp:DropDownList ID="ddlİlaç" runat="server" CssClass="btn btn-success form-control" DataValueField="ID" DataTextField="AdGram" AutoPostBack="True"></asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">İlaç Adet</span>
                                                </div>
                                                <input id="adetText" type="text" class="form-control" runat="server" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <asp:GridView ID="ilaclisteleGridView1" runat="server" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal" HorizontalAlign="Center" OnRowCommand="ilaclisteleGridView1_RowCommand">
                                        ...
                                        <Columns>
                                            <asp:ButtonField ButtonType="Button" CommandName="Select" ControlStyle-CssClass="btn btn-danger" HeaderText="Silme İşlemi" ShowHeader="True" Text="Sil">
