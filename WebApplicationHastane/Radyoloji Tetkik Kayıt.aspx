<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Radyoloji Tetkik Kayıt.aspx.cs" Inherits="WebApplicationHastane.Radyoloji_Tetkik_Kayıt" %>
                                        ...
                                        <div class="col-12">
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">Yeni Radyoloji Alan Adını Giriniz</span>
                                                </div>
                                                <input id="RadyolojiText" type="text" class="form-control" runat="server" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <asp:Button ID="Kaydetbutton" runat="server" Text="Yeni Radyoloji Alanı Kaydet" class="btn btn-primary form-control" OnClick="Kaydetbutton_Click" />
                                        </div>
                                    </div>
                                </div>
                                <div class="tm-bg-black-transparent tm-services-detail-box">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">Radyoloji Adını Seçin</span>
                                                </div>
                                                <asp:DropDownList ID="ddlRadyoloji" runat="server" CssClass="form-control btn btn-primary" DataValueField="Id" DataTextField="Ad"></asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">Radyoloji Tetkinin Adını Giriniz</span>
                                                </div>
                                                <input id="TetkikText" type="text" class="form-control" runat="server" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <asp:Button ID="TetkikKaydet" runat="server" Text="Tetkik Kaydet" class="btn btn-primary form-control" OnClick="TetkikKaydet_Click"/>
                                        </div>
                                    </div>
                                </div>
                            </ContentTemplate>
