<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kan Tahlil Tetkik Kayıt.aspx.cs" Inherits="WebApplicationHastane.Kan_Tahlil_Tetkik_Kayıt" %>
                    ...
                    <div class="col-12">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        ...
                                        <div class="col-12">
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">Yeni Tetkik Alan Adını Giriniz</span>
                                                </div>
                                                <input id="LaboratuvarText" type="text" class="form-control" runat="server" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <asp:Button ID="Kaydetbutton" runat="server" Text="Yeni Kan Tahlil Alanı Kaydet" class="btn btn-primary form-control" OnClick="Kaydetbutton_Click" />
                                        </div>
                                    </div>
                                </div>
                                <div class="tm-bg-black-transparent tm-services-detail-box">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">Tetkik Alanını Seçin</span>
                                                </div>
                                                <asp:DropDownList ID="ddlTetkik" runat="server" CssClass="form-control btn btn-primary" DataValueField="Id" DataTextField="Ad"></asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">Kan Tetkinin Tahlil Adını Giriniz</span>
                                                </div>
                                                <input id="TahlilText" type="text" class="form-control" runat="server" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <asp:Button ID="TetkikKaydet" runat="server" Text="Tahlil Kaydet" class="btn btn-primary form-control" OnClick="TetkikKaydet_Click"/>
                                        </div>
                                    </div>
                                </div>
                            </ContentTemplate>
                            <Triggers>
                                ...
                                <asp:AsyncPostBackTrigger ControlID="TetkikKaydet" EventName="Click" />
                            </Triggers>
                        </asp:UpdatePanel>
                    </div>
                </section>
