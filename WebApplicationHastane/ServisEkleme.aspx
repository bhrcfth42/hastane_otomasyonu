<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServisEkleme.aspx.cs" Inherits="WebApplicationHastane.ServisEkleme" %>
                ...
                <section class="row" id="tmServices">
                    <div class="col-12">
                        <div class="parallax-window tm-services-parallax-header"
                            ...
                            data-z-index="101"
                            data-image-src="login/images/hospital-room-and-bed.jpg">

                            <div class="tm-bg-black-transparent text-center tm-services-header">
                                <h2 class="text-uppercase tm-services-page-title">SERVİS KAYIT</h2>
                                <p class="tm-services-description mb-0 small">
                                    Hastaneye Yeni Servis Ekleme
                                </p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input id="servisText" type="text" class="form-control" runat="server" />
                                            </div>

                                        </div>
                                        <div class="col-12">
                                            <asp:Button ID="servisekleButton" runat="server" Text="Yeni Servisi Kaydet" CssClass="form-control btn btn-primary" OnClick="servisekleButton_Click" />
                                        </div>
                                    </div>
                                </div>                                
                            </ContentTemplate>
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="servisekleButton" EventName="Click" />
                            </Triggers>
                        </asp:UpdatePanel>
                    </div>
                </section>
