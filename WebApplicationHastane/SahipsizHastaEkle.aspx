<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SahipsizHastaEkle.aspx.cs" Inherits="WebApplicationHastane.SahipsizHastaEkle" %>
                    ...
                    <div class="col-12">
                        <div class="parallax-window tm-services-parallax-header"
                            ...
                            <div class="tm-bg-black-transparent text-center tm-services-header">
                                <h2 class="text-uppercase tm-services-page-title">HASTA KAYIT</h2>
                                <p class="tm-services-description mb-0 small">
                                    Hasta Bilgileri Kaydetme İşlemi
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <ContentTemplate>
                                <div class="tm-bg-black-transparent tm-services-detail-box">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <asp:Button ID="Button1" runat="server" Text="Kaydet" CssClass="btn btn-success form-control" OnClick="Button1_Click" />
                                        </div>
                                    </div>
                                </div>
                            </ContentTemplate>
